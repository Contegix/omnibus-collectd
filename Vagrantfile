...
#  end
  ...
  config.vm.define 'centos6-64' do |c|
    c.berkshelf.berksfile_path = "./Berksfile"
    c.vm.box = "centos6-64"
    c.vm.box_url = "http://puppet-vagrant-boxes.puppetlabs.com/centos-64-x64-vbox4210-nocm.box"
  end
  ...
  config.vm.provision :chef_solo do |chef|
    chef.json = {
      "omnibus" => {
        ...
        "install_dir" => "/opt/contegix/#{project_name}"
      }
    }
